        ...
        <AnimatedSection className="relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20 relative">
            <div className="text-center">
              <div className="relative flex justify-center items-center w-[220px] h-[220px] mx-auto mb-8">
              ...
              >
                <Link
                  href="/proyects"
                  className="group bg-gradient-to-r from-[#EA906C] via-[#B31312] to-[#2B2A4C] text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 shadow-lg hover:opacity-90 hover:shadow-[0_0_20px_rgba(234,144,108,0.4)] inline-flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="group border-2 border-white/20 text-gray-300 px-8 py-4 rounded-xl font-semibold hover:border-[#EA906C] hover:text-[#EA906C] hover:bg-[#EA906C]/10 transition-all duration-300 inline-flex items-center justify-center gap-2"
                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="order-2 lg:order-1">
                ...
                >
                  <div className="text-center p-6 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl">
                    <h3 className="text-3xl font-bold text-blue-400 mb-2">3+</h3>
                    <p className="text-gray-300 font-medium">Proyectos Completados</p>
                  </div>
                </motion.div>
              </div>
              <motion.div
